		...
		<div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="space-y-6">
                        ...
                        <div class="">
                            <input require class="w-full text-sm px-4 py-3 bg-gray-200 focus:bg-gray-100 border border-gray-200 rounded-lg focus:outline-none focus:border-purple-400" type="email" name="email" id="email" placeholder="Email">
                        </div>
                        ...
                        <div class="relative" x-data="{ show: true }">
                            ...
                            <div>
                                <button type="submit" class="w-full flex justify-center bg-blue-800  hover:bblue-700 text-gray-100 p-3  rounded-lg tracking-wide font-semibold  cursor-pointer transition ease-in duration-500">
                                    Sign in
                                </button>
                            </div>
                            </form>
                    ...
                    <div class="mt-7 text-center text-gray-300 text-xs">
                        <span>
                    Copyright © 2021-2023 <span class="text-blue-500 hover:text-blue-600"> QuerySet</span>
